...
export const metadata: Metadata = {
  title: "Birendra Joshi | Portfolio",
  description: "Portfolio of Birendra Joshi — Aspiring Full Stack Developer from Nepal specializing in React, Next.js, TypeScript, AI Web Development, and modern web technologies.",
};
