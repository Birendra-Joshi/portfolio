...
const page = () => {
  const links = [
    {
      name: "GitHub",
      path: "https://github.com/Birendra-Joshi",
      icons: <FaGithub />,
    },
    {
      name: "Instagram",
      path: "https://www.instagram.com/your_instagram/",
      icons: <FaInstagram />,
    },
    {
      name: "LinkedIn",
      ...
      <div className="">
        <div>
          ...
          <p className="text-3xl mt-6 text-gray-800 dark:text-gray-200 leading-tight">
            Hi, I&apos;m Birendra Joshi, an aspiring Full-Stack
            Developer from Nepal. I love building modern web applications
            using React, Next.js, and TypeScript — and I&apos;m deeply
            interested in AI web development, data science, PCB design,
        ...
        <div className="mt-8">
          <div className="flex justify-baseline gap-6">
            ...
            <div className="space-y-1">
              ...
              <p className="text-lg text-gray-500 dark:text-gray-400">your_year – present</p>
              <p className="text-xl text-gray-600 dark:text-gray-400 italic">Secondary Education (SEE) / +2</p>
            </div>
          </div>
        </div>
      </div>
