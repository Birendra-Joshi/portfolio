...
const socialLinks = [
  { icon: AiOutlineGithub, href: "https://github.com/Birendra-Joshi", label: "GitHub" },
  { icon: FaLinkedin, href: "https://www.linkedin.com/in/your-linkedin/", label: "LinkedIn" },
  { icon: FaInstagram, href: "https://www.instagram.com/your_instagram/", label: "Instagram" },
  { icon: MdOutlineMail, href: "mailto:dev.bireyy@gmail.com", label: "Email" },
];
